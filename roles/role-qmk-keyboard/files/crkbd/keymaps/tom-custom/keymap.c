...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
     KC_LSFT, KC_LEFT, KC_DOWN,  KC_UP,  KC_RIGHT,  KC_NO,           KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_NO, KC_NO,
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
     KC_NO,   KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,                   KC_NO, KC_NO, KC_NO, KC_NO,KC_NO,KC_NO, 

                                    KC_LALT, LOWER,KC_ENT,   KC_ENT, RAISE,KC_RALT
                                  //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                KC_LGUI, LOWER,KC_DEL,   KC_ENT, RAISE,KC_RALT
                              //`--------------------'  `--------------------'
  ),
